...
#include "stm32f10x.h"
extern const u8 RF2G4_ADDR_TX[5];		// 0X6A,0X69,0X78,0X69,0X6E
extern const u8 RF2G4_ADDR_RX[5];		// ASCII：jixin
extern u8 RF2G4_Send_Data[14] ;		// 2.4G发射数据缓存数组
			 
extern u8 RF2G4_Receive_Data[14];	// 2.4G接收数据缓存数组
//SI24R1寄存器操作命令
//-----------------------------------------------------------------------------------
